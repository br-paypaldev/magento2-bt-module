...
use Paypal\BraintreeBrasil\Observer\GooglePay\DataAssignObserver;
...
class PaymentDataBuilder implements BuilderInterface
{
    ...
    public function build(array $buildSubject)
    {
        ...
        $capture = $this->googlePayConfig->getPaymentAction() === PaymentAction::PAYMENT_ACTION_AUTHORIZE_CAPTURE;
        ...
        if ($this->googlePayConfig->getMerchantAccountId()) {
            $request['merchantAccountId'] = $this->googlePayConfig->getMerchantAccountId();
        }
