...
class Config extends GatewayConfig
{
    ...
    {
        $storeId = $this->storeResolver->getCurrentStoreId();
        return $this->getValue(self::STORE_LABEL, $storeId);
    }
