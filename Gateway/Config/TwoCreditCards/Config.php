...
namespace Paypal\BraintreeBrasil\Gateway\Config\TwoCreditCards;
...
class Config extends GatewayConfig
{
    ...
    const KEY_CAPTURE_AFTER_AUTHORIZE = 'capture_after_authorize';
    ...
    public function __construct(
        ...
        $methodCode = 'paypal_braintree_brasil_two_creditcards',
     ...
     * @return string|null
     */
    public function getCaptureAfterAuthorize()
    {
        $storeId = $this->storeResolver->getCurrentStoreId();
        return $this->getValue(self::KEY_CAPTURE_AFTER_AUTHORIZE, $storeId);
    }
